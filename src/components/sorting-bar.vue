                ...
                <div v-if="filters">                
                    ...
                    <div class="tags" v-if="tagsOpen">
                        <span v-for="tag in tags" v-bind:key="tag.index">
                            <input type="checkbox" :value="tag" :id="tag"/>
                    ...
                    <div class="ages">
                        <span v-for="age in ages" v-bind:key="age.index">
                            <input class="sorting__checkbox" type="checkbox" :value="age" :id="age"/>
                            <label :for="age">{{age}}</label>
                        </span>
                    </div>
                    <button class="sorting__button" type="submit">Применить фильтры</button>
