<template>
  <div class="item-card" @mouseenter="addClass" @mouseleave="removeClass">
    <router-link
      ...
      class="item-card__link-wrapper"
    >
      <img
        class="item-card__pic"
        :src="itemData.pics[0]"
        width="220"
        height="178"
        :alt="itemData.title"
...
export default {
  ...
  data() {
    return {
      buttonContent: Math.ceil(this.itemData.price) + "₽"
    };
  },
  methods: {
    addClass() {
