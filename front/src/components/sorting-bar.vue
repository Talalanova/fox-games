  ...
  <div class="sorting-bar sorting">
    <div class="sorting__tabs">
      ...
      <span
        ...
        :class="[filters === true ? 'sorting__tab--active' : '']"
      >
        <svg
          width="15"
          height="15"
        ...
        <div v-if="filters">
          ...
          <span class="tags-wrapper">
            ...
            <button type="button" @click="tagsOpen = !tagsOpen">
              ...
              >
                <path
                  d="M35.5884 0C37.7975 0 39.5884 1.79086 39.5884 4V24C39.5884 26.2091 37.7975 28 35.5884 28H0.764851V0L35.5884 0Z"
                  fill="#CB7D49"
                />
                <path
                  d="M25.7168 10L20.4641 17.5885C20.3845 17.7034 20.2147 17.7034 20.1352 17.5885L14.8824 10"
                  stroke="white"
                  stroke-width="3"
          ...
          <button class="sorting__button sorting__button--reset" type="reset">
            Сбросить фильтры
          </button>
        </div>
      </form>
      ...
      if (params.age_from) {
        ...
        filter = filter.concat(
          `&age_from=` +
            params.age_from[0] +
            `&age_to=` +
            params.age_from[params.age_from.length - 1]
        );
      }
      if (params.tags) {
