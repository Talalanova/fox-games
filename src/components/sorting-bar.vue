<template>
    <div class="sorting-bar sorting">
        <div class="sorting__tabs">
            ...
            <span class="sorting__tab" @click="sorting = !sorting" :class="[sorting === false ? 'sorting__tab--active' : '']">
            ...
            <div v-if="sorting">
                <form method="post" action="#">
                    ...
                    <div class="tags" v-if="tagsOpen">
                        <label :for="tag" v-for="tag in tags" v-bind:key="tag.index">{{tag}}
...
.tags-wrapper {
    display: grid;
    grid-template-columns: 157px 38px;
