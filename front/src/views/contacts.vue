  ...
  <div class="contacts">
      ...
      <div class="contacts__info">
        ...
        <form method="post" name="feedback">
          ...
          <textarea
            ...
            required
          ></textarea>
          <button class="contacts__submit-button" type="submit" @click.prevent="addFeedback">
            {{ buttonText }}
          </button>
        </form>
      </div>
    ...
    <div class="error" v-if="error">
      <div class="overlay" @click.self="error = !error">
        ...
        <h1>
          Что-то пошло не так. Попробуйте перезагрузить страницу или вернуться
          позже
        </h1>
      </div>
    </div>
...
@-moz-document url-prefix() {
  .contacts__submit-button { bottom: -7px;}
}
