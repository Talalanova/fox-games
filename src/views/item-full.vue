  ...
  <div class="item-page item">    
    ...
    <div id="tabs" class="container">
        <div class="tabs">
          ...
          <a v-on:click="activetab='5'" v-bind:class="[ activetab === '5' ? 'active' : '' ]">Отзывы и вопросы</a>
        </div>
        <div class="content">
          ...
          <div v-if="activetab ==='3'" class="tabcontent">
            Какой то контент для вкладок будеть туть
          </div>
...
<script>
import {itemParameters,itemData} from '@/data.js'
